function [acc]=cnnTrain_on_user(images,labels,testImages,testLabels)
...
% Load trainingSet
% addpath ../SUSig/;
% images = load('../SUsig/X_train');
% images=getfield(images,'X_train');
% labels = load('../SUsig/Y_train');
% labels=getfield(labels,'Y_train');
% labels=labels';
...
% testImages = load('../SUsig/X_test');
% testImages=getfield(testImages,'X_test');
% % testImages = loadMNISTImages('../common/t10k-images-idx3-ubyte');
% % testImages = reshape(testImages,imageDim,imageDim,[]);
% testLabels = load('../SUsig/Y_test');
% testLabels=getfield(testLabels,'Y_test');
